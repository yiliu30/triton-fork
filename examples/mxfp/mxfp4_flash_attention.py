...
import triton_sm100_fix  # must be before any @triton.jit kernel runs
import torch
import triton
...
def test_mxfp4_flash_attention():
    """Test MXFP4 flash attention against torch SDPA on dequantized inputs."""
    print("=" * 60)
    print("Testing MXFP4 Flash Attention (dot_scaled e2m1) vs SDPA")
    print("=" * 60)
    ...
    for B, H, N, D, causal in configs:
        # Generate random fp16 data (small magnitude for FP4 range)
        ...
        # For V: pack along N (sequence) dimension, stored as [B, H, D, N//2]
        ...
        # FP4 has much coarser quantization, expect larger errors
        threshold = 2.0 if causal else 1.0
...
def benchmark_mxfp4_flash_attention():
    """Benchmark MXFP4 flash attention and report TFLOPS."""
    print("=" * 60)
    print("Benchmarking MXFP4 Flash Attention (dot_scaled e2m1)")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    test_mxfp4_flash_attention()
    benchmark_mxfp4_flash_attention()
